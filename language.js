...
const words = {
    ...
    userNotExist: { ml: "ഈ യൂസർനെയിം നിലവിലില്ല!", en: "Username does not exist!", hi: "यह यूजरनेम मौजूद नहीं है!", ta: "இந்த பயனர்பெயர் இல்லை!", kn: "ಈ ಬಳಕೆದಾರಹೆಸರು ಅಸ್ತಿತ್ವದಲ್ಲಿಲ್ಲ!", bn: "এই ইউজারনেমটি বিদ্যমান নেই!", as: "এই ইউজাৰনেমটো অস্তিত্বত নাই!" },
    ...
    // പുതിയ ഇൻഡെക്സ് രജിസ്ട്രേഷൻ ബട്ടൺ കീ (Index Page New Registration Button)
    ...
    bank: { ml: "ബാങ്ക്", en: "Bank", hi: "வங்கி", kn: "ಬ್ಯಾಂಕ್", bn: "ব্যাংক", as: "বেংক" },
    ...
    "history_edit": {
        ...
        "hi": "हिस्ट्री और एडिट",
        "kn": "ಖಾತೆ ಇತಿಹಾಸ & ಸಂಪಾದನೆ",
        "as": "হিস্তৰি আৰু সম্পাদনা",
        "bn": "হিস্ট্রি ও এডিট"
    },
    // ജീവനക്കാരുടെ ശമ്പളം
    "staff_salary": {
    ...
    "attendance_report": {
        ...
        "bn": "উপস্থিতি ও কাজের রিপোর্ট"
    },
    // വാടക ഉപകരണങ്ങൾ
    "rentals": {
        "ml": "വാടക ഉപകരണങ്ങൾ",
        "en": "Rentals / Equipment",
        "ta": "வாடகை உபகரணங்கள்",
        "hi": "किराए के उपकरण",
        "kn": "ಬಾಡಿಗೆ ಉಪಕರಣಗಳು",
        "as": "ভাৰাতীয়া সঁজুলি",
    ...
    "estimator": {
        ...
        "kn": "ಸಾಮಗ್ರಿ & ಕಾರ್ಮಿಕ ಅಂದಾಜು",
        "as": "সামগ্ৰী আৰু শ্ৰমিকৰ আনুমানিক হিচাপ",
        "bn": "উপকরণ ও শ্রম প্রাক্কলন"
    },
    // വാട്സാപ്പ് സപ്പോർട്ട്
    "whatsapp_support": {
        "ml": "💬 സംശയങ്ങൾക്ക് വാട്സാപ്പിൽ ബന്ധപ്പെടുക",
        "en": "💬 Contact via WhatsApp for support",
        "ta": "💬 சந்தேகங்களுக்கு வாட்ஸ்அப்பில் தொடர்பு கொள்ளவும்",
        "hi": "💬 शंकाओं के लिए व्हाट्सएप पर संपर्क करें",
        "kn": "💬 ಸಂದೇಹಗಳಿಗಾಗಿ ವಾಟ್ಸಾಪ್‌ನಲ್ಲಿ ಸಂಪರ್ಕಿಸಿ",
    ...
    // ആഴ്ചയിലെ ദിവസങ്ങൾ (Days of the week)
        "days": {
        ...
        "kn": ["ಭಾನುವಾರ", "ಸೋಮವಾರ", "ಮಂಗಳವಾರ", "ಬುಧವಾರ", "ಗುರುವಾರ", "ಶುಕ್ರವಾರ", "ಶನಿವಾರ"], // ഇത് ശരിയാക്കി നൽകിയിട്ടുണ്ട്
        "as": ["দেওবাৰ", "সোমবাৰ", "মঙলবাৰ", "বুধবাৰ", "বৃহস্পতিবাৰ", "শুক্ৰবাৰ", "শনিবাৰ"],
        "bn": ["রবিবার", "সোমবার", "মঙ্গলবার", "বুধবার", "বৃহস্পতিবার", "শুক্রবার", "শনিবার"]
    },


    // മാസങ്ങളുടെ പേരുകൾ (Months)
    "months": {
        ...
        "kn": ["ಜನವರಿ", "ಫೆಬ್ರವರಿ", "ಮಾರ್ಚ್", "ಏಪ್ರಿಲ್", "ಮೇ", "ಜೂನ್", "ಜುಲೈ", "ಆಗಸ್ಟ್", "ಸೆಪ್ಟೆಂಬರ್", "ಅಕ್ಟೋಬರ್", "ನವೆಂಬರ್", "ಡಿಸೆಂಬർ"],
        "as": ["জানুৱাৰী", "ফেব্ৰুৱাৰী", "মাৰ্চ", "এপ্ৰিল", "মে'", "জুন", "জুলাই", "আগষ্ট", "ছেপ্টেম্বৰ", "অক্টোবৰ", "নৱেম্বৰ", "ডিচেম্বৰ"],
        "bn": ["জানুয়ারি", "ফেব্রুয়ারি", "মার্চ", "এপ্রিল", "মে", "জুন", "জুলাই", "আগস্ট", "সেপ্টেম্বর", "অক্টোবর", "নভেম্বর", "ডিসেম্বর"]
    },

    // "ഇന്ന്:" എന്നതിന് പകരം ഉപയോഗിക്കാൻ (Today text)
    "today_label": {
        "ml": "ഇന്ന്",
        "en": "Today",
        "ta": "இன்று",
