...
const words = {
    ...
    const words = {
    regTitle: { ml: "പുതിയ രജിസ്ട്രേഷൻ", ta: "புதிய பதிவு", kn: "ಹೊಸ ನೋಂದಣಿ", hi: "नया पंजीकरण" },
    regSubtitle: { ml: "വിവരങ്ങൾ നൽകി പുതിയ അക്കൗണ്ട് ഉണ്ടാക്കാം", ta: "விவரங்களை உள்ளிட்டு புதிய கணக்கை உருவாக்கலாம்", kn: "ವಿವರಗಳನ್ನು ನೀಡಿ ಹೊಸ ಖಾತೆಯನ್ನು ರಚಿಸಿ", hi: "विवरण देकर नया खाता बनाएं" },
    mesthriNameLabel: { ml: "മേസ്തിരിയുടെ പേര്", ta: "மேஸ்திரியின் பெயர்", kn: "ಮೇಸ್ತ್ರಿಯ ಹೆಸರು", hi: "मेस्त्री का नाम" },
    phoneLabel: { ml: "ഫോൺ നമ്പർ", ta: "தொலைபேசி எண்", kn: "ಫೋನ್ ಸಂಖ್ಯೆ", hi: "फोन नंबर" },
    passwordLabel: { ml: "പാസ്‌വേർഡ് (Password)", ta: "கடவுச்சொல் (Password)", kn: "ಪಾಸ್‌ವರ್ಡ್ (Password)", hi: "पासवर्ड (Password)" },
    registerSubmitBtn: { ml: "അക്കൗണ്ട് രജിസ്റ്റർ ചെയ്യാം", ta: "கணக்கை பதிவு செய்க", kn: "ಖಾತೆಯನ್ನು ನೋಂದಾಯಿಸಿ", hi: "खाता रजिस्टर करें" }
},
