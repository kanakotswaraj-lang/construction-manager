         ...
         <div class="flex items-center justify-center bg-gradient-to-r from-[#2c1810] via-[#3d2314] to-[#2c1810] text-amber-200 px-6 py-4 rounded-full border-2 border-amber-400 shadow-[0_0_35px_rgba(251,191,36,0.6)] w-full relative">
            ...
            <div class="flex items-center gap-4 w-full max-w-[320px] justify-center">
                ...
                <div class="flex flex-col items-start overflow-hidden">
                    ...
                    <div class="relative flex items-center bg-amber-500/20 px-2.5 py-1 rounded-xl border border-amber-400/70 shadow-[0_0_15px_rgba(251,191,36,0.3)] mt-1.5 w-fit">
                        <select id="langSelectDropdown" onchange="window.changeLanguageFromDropdown(this.value)" class="bg-gradient-to-r from-amber-400 via-amber-300 to-yellow-400 text-slate-950 px-2.5 py-1 rounded-lg text-xs sm:text-sm font-black shadow-md transition cursor-pointer outline-none border border-slate-950 truncate">
